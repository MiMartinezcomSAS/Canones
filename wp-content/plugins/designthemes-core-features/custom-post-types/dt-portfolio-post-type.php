	...
	class DTPortfolioPostType {
		...
		function save_post_meta($post_id) {
			...
			if(isset($_POST['layout'])) :
				...
				$settings['disable_breadcrumb_section'] =  isset ( $_POST ['mytheme-disable-breadcrumb-section'] ) ? stripslashes ( $_POST ['mytheme-disable-breadcrumb-section'] ) : "";
				$settings['breadcrumb-bg'] = isset ( $_POST ['breadcrumb-bg'] ) ? stripslashes ( $_POST ['breadcrumb-bg'] ) : "";
				$settings['breadcrumb-bg-repeat'] = isset ( $_POST ['breadcrumb-bg-repeat'] ) ? stripslashes ( $_POST ['breadcrumb-bg-repeat'] ) : "";
				$settings['breadcrumb-bg-position'] = isset ( $_POST ['breadcrumb-bg-position'] ) ? stripslashes ( $_POST ['breadcrumb-bg-position'] ) : "";
				$settings['breadcrumb-darkbg'] = isset ( $_POST ['breadcrumb-darkbg'] ) ? stripslashes ( $_POST ['breadcrumb-darkbg'] ) : "";
				
				$settings ['client-name'] = isset ( $_POST ['client-name'] ) ? stripslashes ( $_POST ['client-name'] ) : "";
				$settings ['location'] = isset ( $_POST ['location'] ) ? stripslashes ( $_POST ['location'] ) : "";
				...
				$settings ['show-subtitle-category'] = isset ( $_POST ['mytheme-subtitle-category'] ) ? $_POST ['mytheme-subtitle-category'] : "";
