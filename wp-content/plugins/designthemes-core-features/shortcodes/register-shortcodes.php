	...
	class DTCoreShortcodes {
		...
		function dt_init() {
			...
			if (! is_admin ()) {
				...
				wp_enqueue_script ( 'dt-sc-animatenumber-script', plugin_dir_url ( __FILE__ ) . 'js/jquery.animateNumber.min.js', array(), false, true);
				wp_enqueue_script ( 'dt-sc-jcarousel', plugin_dir_url ( __FILE__ ) . 'js/jquery.jcarousel.min.js', array(), false, true);
		...
		function dt_the_content_filter($content) {
			$dt_shortcodes = array("dt_sc_accordion_group","dt_sc_button","dt_sc_blockquote","dt_sc_callout_box","dt_sc_one_half","dt_sc_one_third","dt_sc_one_fourth",
				"dt_sc_one_fifth","dt_sc_one_sixth","dt_sc_two_sixth","dt_sc_two_third","dt_sc_three_fourth","dt_sc_two_fifth","dt_sc_three_fifth","dt_sc_four_four",
				...
				"dt_sc_five_sixth_inner","dt_sc_four_fifth_inner","dt_sc_address","dt_sc_phone","dt_sc_fax","dt_sc_email","dt_sc_web",
				"dt_sc_clear","dt_sc_hr_border","dt_sc_hr_invisible",
				...
				"dt_sc_donutchart_large","dt_sc_icon_box","dt_sc_code",
				...
				"dt_sc_tooltip","dt_sc_pullquote","dt_sc_fullwidth_section",
				"dt_sc_twitter",
				"dt_sc_widgets","dt_sc_doshortcode","dt_sc_resizable","dt_sc_resizable_inner",
				"dt_sc_slider_pattern", "dt_sc_slider_videobackground", "dt_sc_slider_parallax", "dt_sc_slider_portfolio");
