jQuery(document).ready(function($){
	...
	$( 'body' ).delegate( '.dt_settings_arrow_column', 'click', function(){
		var dt_action = 'dt_show_columoptions_panel', this_column = $(this), dt_column_type = dt_column_css = dt_column_animation_type = dt_column_animation_delay = '';
	...
	$( 'body' ).delegate( 'form#dt_column_settings span#save_columnoptions', 'click', function(){
		...
		var column_type = column_css = column_animation_type = column_animation_delay = '', $save_message = $("#dtthemes_ajax_save");
		...
		$('.dt_active_column .dt_columndata_settings').append( '<div id="column_data" ' + column_type + column_css + column_animation_type + column_animation_delay + '></div>' );
