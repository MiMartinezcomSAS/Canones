            ...
            <div class="bpanel-box">
                    ...
                    <div class="box-content">
                     ...
                     <h6> <?php _e('Disable Loading Bar','dt_themes'); ?></h6>
                      ...
                      <div class="column one-half last">
                      	<p class="note no-margin"><?php _e('Paste your mailchimp api key that will be used by the mailchimp widget and newsletter shortcode.','dt_themes'); ?></p>
                      </div>
                      
                      <div class="clear"> </div>
                      <div class="hr-invisible-small"> </div><div class="hr-invisible-small"> </div><div class="hr-invisible-small"> </div>
