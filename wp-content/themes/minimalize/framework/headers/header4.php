<section id="panel">
	<div class="container">
		    <header id="header" class="<?php echo ' dt-toggle-header'; ?>">
                ...
                <div id="menu-container" class="menu-main-menu-container">
                    <!--nav starts-->
                    <nav id="main-menu">
                        <?php 
        ...
        <!--logo starts-->
        <div id="logo" class="logo toggle-menu">
			<?php
			$blog_title = dttheme_blog_title();
            if( dttheme_option('general', 'logo') ):
				$dark_layout = dttheme_option('general','enable-dark-layout');
                ...
                ?>
                <a href="<?php echo home_url();?>" title="<?php echo esc_attr($blog_title);?>">
                    <img class="normal_logo" src="<?php echo esc_url($url);?>" alt="<?php echo esc_attr($blog_title); ?>" title="<?php echo esc_attr($blog_title); ?>" id="dt_togglelogo" />
                    <img class="retina_logo" src="<?php echo esc_url($retina_url);?>" alt="<?php echo esc_attr($blog_title);?>" title="<?php echo esc_attr($blog_title); ?>" style="width:<?php echo esc_attr($width); ?>; height:<?php echo esc_attr($height); ?>;" id="dt_retina_togglelogo" />
                </a><?php
            else:?>
                <h2><a href="<?php echo home_url();?>" title="<?php echo esc_attr($blog_title);?>"><?php echo do_shortcode(get_option('blogname')); ?></a></h2><?php
            endif;?>
