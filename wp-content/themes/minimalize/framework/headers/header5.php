    <header id="header" class="<?php echo ' dt-menuoverslider'; ?>">
        ...
        <div class="container">
            ...
            <div id="logo">
                ...
                if( dttheme_option('general', 'logo') ):
                    ...
                    $url = !empty( $url ) ? $url : IAMD_BASE_URL."images/logo-dark.png";

                    $retina_url = dttheme_option('general','retina-logo-url');
                    $retina_url = !empty($retina_url) ? $retina_url : IAMD_BASE_URL."images/logo-dark@2x.png";
