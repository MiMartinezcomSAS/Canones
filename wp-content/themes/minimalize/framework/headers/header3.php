    <header id="header-not-sticky" class="<?php echo ' with-navicon'; ?>">
        ...
        <div class="container">
            ...
            <div id="menu-container" class="menu-main-menu-container">
                <!--nav starts-->
                <nav id="main-menu" class="menu-light">
                    <?php 
        ...
        <nav class="nav-roundslide collapse">
        <a class="menu-btn">
           <?php echo '<h3>M<i class="fa fa-navicon "></i>NU</h3>'; ?>
        </a>
    </nav>
