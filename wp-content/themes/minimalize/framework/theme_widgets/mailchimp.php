	...
	function widget($args, $instance) {
		...
		if( isset( $_REQUEST['mythem_mc_emailid']) ):
			...
			if($mcapi->listSubscribe($list_id, $_REQUEST['mythem_mc_emailid'], $merge_vars ) ):
				// It worked!   
				$msg = '<span class="success-msg" style="color:#76EE00;">'.__('Success!&nbsp; Please check your inbox or spam folder.','dt_themes').'</span>';
			else:
				// An error ocurred, return error message   
				$msg = '<span class="error-msg" style="color:#ff0000;"><b>'.__('Error:','dt_themes').'</b>&nbsp; ' . $mcapi->errorMessage.'</span>';
			endif;
