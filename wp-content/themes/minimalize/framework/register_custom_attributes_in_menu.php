				...
				<!-- DesignThemes Custom Code Begins Here-->
	                ...
	                <p class="field-dt-disable-text description description-thin">
	                	<label for="edit-menu-item-dt-disable-text-<?php echo esc_attr($item_id); ?>">
	                    	<input type="checkbox" id="edit-menu-item-dt-disable-text-<?php echo esc_attr($item_id); ?>" value="1" name="dt-disable-text[<?php echo $item_id; ?>]"<?php checked( $value, 1 ); ?> />
	                ...
	                <p class="field-dt-disable-link description description-thin">
	                	<label for="edit-menu-item-dt-disable-link-<?php echo esc_attr($item_id); ?>">
	                    	<input type="checkbox" id="edit-menu-item-dt-disable-link-<?php echo esc_attr($item_id); ?>" value="1" name="dt-disable-link[<?php echo $item_id; ?>]"<?php checked( $value, 1 ); ?> />
	                ...
	                <p class="field-dt-fullwidth description description-thin">
	                	<label for="edit-menu-item-dt-fullwidth<?php echo esc_attr($item_id); ?>">
	                    	<input type="checkbox" id="edit-menu-item-dt-fullwidth<?php echo esc_attr($item_id); ?>" value="1" name="dt-fullwidth[<?php echo $item_id; ?>]"<?php checked( $value, 1 ); ?> />
                    ...
                    <p class="field-dt-content description description-wide">
                        <label for="edit-menu-item-dt-content-<?php echo esc_attr($item_id); ?>">
                            ...
                            <textarea id="edit-menu-item-dt-content-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-dt-content" rows="3" cols="20" name="dt-content[<?php echo $item_id; ?>]"><?php echo esc_html( $value); // textarea_escaped ?></textarea>
