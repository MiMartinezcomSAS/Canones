...
function dttheme_default_option() {
	...
	$general = array(
				...
				"disable-picker"		=>"on",
				"show-footer-logo"		=>"on",
				"copyright-text" => 'Copyright &copy; 2015 Minimalize Theme All Rights Reserved | <a href="http://themeforest.net/user/designthemes" title=""> Design Themes </a>');
				
	$appearance = array("layout" => "wide","disable-menu-settings" => "true","disable-typography-settings" => "true","disable-boddy-settings" => "true");
