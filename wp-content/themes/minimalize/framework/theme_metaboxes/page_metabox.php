...
<?php function page_metabox(){
		add_meta_box("page-main-title-container", __('Page Main Title','dt_themes'), "page_main_title_settings", "page", "normal", "default");
	...
	#Page Main Title Meta Box
	function page_main_title_settings($args){	
		global $post; 
        ...
        <div class="custom-box">
        	<div class="column one-sixth">
                <label><?php _e('Page Main Title','dt_themes');?> </label>
            </div>
            <div class="column four-sixth last">
				<?php $switchclass = array_key_exists("show_page_main_title",$tpl_default_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
                      $checked = array_key_exists("show_page_main_title",$tpl_default_settings) ? ' checked="checked"' : '';?>
                <div data-for="mytheme-show-page-main-title" class="checkbox-switch <?php echo $switchclass;?>"></div>
                <input id="mytheme-show-page-main-title" class="hidden" type="checkbox" name="mytheme-show-page-main-title" value="true"  <?php echo $checked;?>/>
                <p class="note"> <?php _e('YES! to hide page main title on this page.','dt_themes');?> </p>
            </div>
        </div><!-- Show Page Title End-->

        <!-- Page Main Title Shortcodes -->
        <div id="pagemaintitleshortcodes">
            
            <div class="custom-box">
                <div class="column one-sixth"><?php _e( 'Enter Page Main Title Shortcodes','dt_themes');?></div>
                <div class="column five-sixth last">
              		<?php $page_main_title_shortcode = array_key_exists ( "page-main-title-shortcode", $tpl_default_settings ) ? $tpl_default_settings ['page-main-title-shortcode'] : '';?>
                    <textarea class="large" name="page-main-title-shortcode" rows="12"><?php echo $page_main_title_shortcode; ?></textarea>
                    <p class="three-fourth note"> <?php _e('You can add shortcodes here to display page main title','dt_themes');?> <br />
					<?php _e('<strong>Note:</strong> Page Main Title options applicable only for one page template','dt_themes');?> </p>
                </div>
            </div>
            
        </div><!--  Page Main Title Shortcodes -->
<?php }
	
	
	#Page Main Title Metabox Ends
                ...
                <div class="custom-box">
                    ...
                    <div class="column five-sixth last">       
                        ...
                        <select class="mytheme-header-styles" name="mytheme-header-styles">
                            <option value="type1" <?php selected ( 'type1', $header_styles, true ); ?>><?php _e('Default', 'dt_themes'); ?></option>
                            <option value="type2" <?php selected ( 'type2', $header_styles, true ); ?>><?php _e('Meanmenu Navigation', 'dt_themes'); ?></option>
                            <option value="type3" <?php selected ( 'type3', $header_styles, true ); ?>><?php _e('Vertical Navigation', 'dt_themes'); ?></option>
                            <option value="type4" <?php selected ( 'type4', $header_styles, true ); ?>><?php _e('Toggle Header', 'dt_themes'); ?></option>
                            <option value="type5" <?php selected ( 'type5', $header_styles, true ); ?>><?php _e('Without Header BG', 'dt_themes'); ?></option>
                            <option value="type6" <?php selected ( 'type6', $header_styles, true ); ?>><?php _e('Slider Over Menu', 'dt_themes'); ?></option>
                        </select>   
...
<?php  wp_reset_postdata();
	...
	function page_meta_save($post_id){
		...
		$settings['show_page_main_title'] =  $_POST['mytheme-show-page-main-title'];
		$settings['page-main-title-shortcode'] = $_POST['page-main-title-shortcode'];
